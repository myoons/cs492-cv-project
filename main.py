...
def run_session(fixmatch, args, labeled_trainloader, unlabeled_w_trainloader, unlabeled_s_trainloader, validation_loader, global_step):
    global best_acc
...
def main():
    ...
    run_session(fixmatch, args, labeled_trainloader, unlabeled_w_trainloader, unlabeled_s_trainloader, validation_loader, global_step)
